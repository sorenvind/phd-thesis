...
\usepackage{upgreek}
\usepackage{amsthm,amsmath,amssymb,nicefrac,graphicx,lastpage,array}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%% Info about papers
\newenvironment{infosection}{\par\vspace*{\fill} \hrule}{\clearpage}
...
\newcommand{\uniname}[2]{\footnotetext[#1]{#2}}
\newcommand{\uni}[1]{\footnotemark[#1]}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
