...
%%%%%%%%%%%%%%%%%%%%%%%%%%% TITLEPAGE %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\author{Roberto Grossi\inst{1}$^{\star}$ \and S{\o}ren Vind\inst{2}$^{\star\star}$}
...
%\footnotetext[1]{Partially supported by Italian MIUR PRIN project AMANDA.} %star
%\footnotetext[2]{
%Supported by a grant from the Danish National Advanced Technology Foundation. 
%Research carried out while the author was visiting Universit\`{a} di Pisa.
%} %starstar
