...
%\documentclass[a4paper,UKenglish,subfig]{lipics}
...
% for section-numbered lemmas etc., use "numberwithinsect"
 ...
 %\usepackage[T1]{fontenc} % Smallcaps in Sections
 %\usepackage{upgreek}
 %\usepackage{cite}
 %\usepackage{amsmath,amssymb,nicefrac,graphicx,lastpage,array}
 %\usepackage{multirow}
 %\usepackage{caption}
...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Output-Sensitive Pattern Extraction in Sequences}
%\titlerunning{Output-Sensitive Pattern Extraction in Sequences} %optional, in case that the title is too long; the running title should fit into the top page column

%\author[1]{Roberto Grossi}
%\author[1]{Giulia Menconi}
%\author[1]{Nadia Pisanti}
%\author[1]{Roberto Trani}
%\author[2]{S{\o}ren Vind$^*$}
%\affil[1]{Universit\`{a} di Pisa, Dipartimento di Informatica\\
%  \texttt{grossi@di.unipi.it, menconigiulia@gmail.com, pisanti@di.unipi.it, tranir@cli.di.unipi.it}}
%\affil[2]{Technical University of Denmark, DTU Compute\\
%  \texttt{sovi@dtu.dk}}
%\authorrunning{R.\,Grossi, G.\,Menconi, N.\,Pisanti, R.\,Trani and S.\,Vind} %mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et. al.'

%\Copyright{Roberto Grossi, Giulia Menconi, Nadia Pisanti, Roberto Trani and S{\o}ren Vind}%mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
