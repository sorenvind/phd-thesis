...
\author[1]{Patrick Hagge Cording}
\author[1]{Inge Li G{\o}rtz\thanks{Supported by a grant from the Danish Council for Independent Research $\vert$ Natural Sciences.}}
\author[2]{Benjamin Sach}
\author[1]{Hjalte Wedel Vildh{\o}j}
\author[1]{S{\o}ren Vind\thanks{Supported by a grant from the Danish National Advanced Technology Foundation.}}
...
\maketitle
{
 ...
 \footnotetext{An extended abstract of this paper appeared at the 13th Algorithms and Data Structures Symposium.}
...
\begin{infosection}
    \uniname{1}{Technical University of Denmark}
    \uniname{2}{University of Warwick}
    \authors{Philip Bille\uni{1}, Patrick Hagge Cording\uni{1}, Inge Li G{\o}rtz\uni{1}\footnote[$\star$]{Supported by a grant from the Danish Council for Independent Research $\vert$ Natural Sciences.}, Benjamin Sach\uni{2}, Hjalte Wedel Vildh{\o}j\uni{1}, and S{\o}ren Vind\uni{1}\footnote[\textdagger]{Supported by a grant from the Danish National Advanced Technology Foundation.}.}
    
    \published{An extended abstract of this paper appeared at the 13th Algorithms and Data Structures Symposium (WADS 2013). %The present full journal version is in submission with Journal of Computer and System Sciences.
    }
\end{infosection}
